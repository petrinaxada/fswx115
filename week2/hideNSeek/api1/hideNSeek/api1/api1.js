...
///PASTE DATA IN JS FILE

///SHOW DATA ON HTML FILE
var api = {
    "results": [
        {
            "title": "A New Hope",
...
api.results.forEach(function(element, i){
    ...
    newElement.textContent = `${api.results[i].title}`;
    newList.appendChild(newElement);
});*/

var display = document.querySelector('#newList')
api.joke.forEach(function(e, i){
    let newElement.textContent = document.createElement('li');
    newElement=`${api.value[i].jokes}`;
